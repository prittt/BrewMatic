...
ER-TFTM080-1 with no touch panel or with capacitive touch panel sets power supply to 5V and 8080-16BIT parallel interface.Meanwhile the Hardware SPI on shield should be short and Software SPI should be open.Capacitive Touch Screen on shield should be short and Resistive Touch Panel should be open. 

ER-TFTM080-1 with Resistive touch panel sets power supply to 5V and 8080-16BIT Parallel interface. Meanwhile the Hardware SPI on shield should be open and Software SPI should be short.Capacitive Touch Screen on shield should be open and Resistive Touch Panel should be open either.
...
// -------------------------------------------------------------
  ...
  //pinMode(53, OUTPUT); // SD card CS pin
  //digitalWrite(53, HIGH); // SD card CS pin
